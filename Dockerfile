...
RUN apt-get -y update && apt-get install -y --no-install-recommends curl openssh-server zip unzip net-tools inetutils-ping iproute2 xorg lxde-core firefox  tightvncserver  \  
