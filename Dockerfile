...
RUN  apt-get -y update && DEBIAN_FRONTEND=noninteractive apt-get install -y  curl openssh-server zip unzip net-tools inetutils-ping iproute2 lubuntu-desktop  tightvncserver tcpdump git \  
